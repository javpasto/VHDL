...
#set_property PACKAGE_PIN W5 [get_ports clk]							
    ...
    set_input_delay -clock [get_clocks {clk}] -min -add_delay 0.00 [get_ports {X[*] Y[*]}]
    set_input_delay -clock [get_clocks {clk}] -max -add_delay 0.01 [get_ports {X[*] Y[*]}]
    
    set_output_delay -clock [get_clocks {clk}] -min -add_delay 0.00 [get_ports {Z[*]}]
    set_output_delay -clock [get_clocks {clk}] -max -add_delay 0.01 [get_ports {Z[*]}]
 
    set_output_delay -clock [get_clocks {clk}] -min -add_delay 0.00 [get_ports {rst}]
    set_output_delay -clock [get_clocks {clk}] -max -add_delay 0.01 [get_ports {rst}]
